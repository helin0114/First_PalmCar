...
public interface TaskContract {
    ...
    interface Presenter extends BasePresenter {
        ...
        void loadTasks(String type,double lat,double lon, boolean showRefreshLoadingUI, int pageCount, int pageSize, String gpsStatus);

        void taskQuery(boolean showRefreshLoadingUI,String type,String applyCD,String customerName,int timeFlag,int pageIndex,int pageSize, String gpsStatus);
    }
}
