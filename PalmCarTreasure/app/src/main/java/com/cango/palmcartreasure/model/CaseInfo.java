...
public class CaseInfo {
    ...
    public static class DataBean {
        ...
        private String hasCarletterPass;
        ...
        public String getHasCarletterPass() {
            return hasCarletterPass;
        }

        public void setHasCarletterPass(String hasCarletterPass) {
            if (CommUtil.checkIsNull(hasCarletterPass))
                hasCarletterPass="";
            this.hasCarletterPass = hasCarletterPass;
        }
