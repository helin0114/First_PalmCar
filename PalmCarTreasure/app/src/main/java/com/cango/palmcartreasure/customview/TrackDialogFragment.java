...
/**
 * Created by cango on 2017/8/7.
 */

public class TrackDialogFragment extends DialogFragment implements OnDateSelectedListener {
    ...
    public static TrackDialogFragment newInstance(int type) {
        TrackDialogFragment trackDialogFragment = new TrackDialogFragment();
        Bundle args = new Bundle();
        args.putInt("type", type);
        trackDialogFragment.setArguments(args);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.track_dialog_fragment, container, false);
