...
import com.cango.palmcartreasure.trailer.taskpictures.TaskPicturesActivity;
...
public class TaskDetailFragment extends BaseFragment implements TaskDetailContract.View, EasyPermissions.PermissionCallbacks {
    ...
    @OnClick({R.id.tv_download, R.id.tv_pictures, R.id.ll_callrecord, R.id.ll_home_visit, R.id.ll_trailer_info, R.id.ll_case_info, R.id.ll_customer_info})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_pictures:
                Intent staiffIntent=new Intent(getActivity(),TaskPicturesActivity.class);
                staiffIntent.putExtra(TaskDetailFragment.TASKLISTBEAN, mTaskListBean);
